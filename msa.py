...
import my_spectrum_analyzer_epy_block_1 as epy_block_1  # embedded python block
...
class my_spectrum_analyzer(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, file_name, center_freq):
        ...
        self.settings = Qt.QSettings("GNU Radio", "my_spectrum_analyzer")
        ...
        self.soapy_bladerf_source_0.set_bandwidth(0, 30000000)
        self.soapy_bladerf_source_0.set_frequency(0, freq)
        self.soapy_bladerf_source_0.set_frequency_correction(0, 0)
        self.soapy_bladerf_source_0.set_gain(0, min(max(0, -1.0), 60.0))
        ...
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_float*2048, 100,True)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*2048, file, False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.analog_sig_source_x_0 = analog.sig_source_c(1000, analog.GR_SQR_WAVE, 10000, 1, 0, 0)
        ...
        self.connect((self.logpwrfft_x_0, 0), (self.blocks_throttle_0, 0))
...
def main(top_block_cls=my_spectrum_analyzer, options=None):
    ...
    tb = top_block_cls(file_name, center_freq)
